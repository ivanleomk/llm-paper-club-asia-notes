...
7. [DeepSeekMoE: Towards Ultimate Expert Specialization in Mixture-of-Experts Language Models]: An introduction to the DeepSeek MOE model](/papers/deekseek-moe) which beats LLama2-7B with only 40% of equivalent computation. 